...
window.DEFAULT_DATA = {
  ...
  projects: [
    ...
    {
      title: '《无尽冬日》 — AI 游戏创意广告',
      cat: 'AIGC 创作',
      period: '2026.06',
      desc: '为《无尽冬日》游戏独立完成的 AI 创意广告短片，从脚本策划、分镜设计到视频生成、后期剪辑均由一人完成。\n-创意策划：深入理解游戏末日生存题材的世界观与用户画像，围绕"资源匮乏、英雄召唤、合作对抗、绝境求生"的核心主题，撰写具有故事张力与情感共鸣的广告脚本，精准传递游戏的策略深度与沉浸感。\n-全流程 AI 制作：运用 AIGC 工具完成角色设计、场景构建与关键镜头生成，结合节奏化剪辑、氛围配乐与电影级调色，将创意概念高效转化为高完成度的商业广告成片。\n-独立交付能力：从前期创意到后期成片全流程单人完成，验证了 AIGC 工作流在商业广告创作场景中的可行性与效率优势，展示了将 AI 工具深度融入创意生产链路的综合能力。',
      meta: ['AI 创意广告', '游戏营销', '全流程单人'],
      link: '',
      workId: 'w18'
    },
    {
      ...
      cat: 'AIGC 创作',
      period: '2026.07',
      desc: '为网易《第五人格》游戏独立完成的 AI 创意广告短片《让爱相遇》，从脚本策划、分镜设计到视频生成、后期剪辑均由一人独立完成。\n-创意策划：围绕游戏独特的美学气质，采用新海诚动漫风格进行创意表达，将"让爱相遇"的情感主题转化为具有治愈感与故事张力的广告叙事。\n-全流程 AI 制作：运用 AIGC 工具完成角色与场景设计、关键镜头生成，结合电影级调色与节奏化剪辑，呈现细腻的光影氛围与情感共鸣。\n-独立交付能力：延续 AI 工作流在商业广告创作中的完整闭环，从前期创意到后期成片全流程单人完成，进一步验证 AIGC 在游戏营销素材生产中的效率与质量优势。',
      meta: ['AI 创意广告', '新海诚风格', '全流程单人'],
      link: '',
      workId: 'w19'
    }
  ],
  ...
  portfolio: [
    ...
    },
    {
      ...
      category: 'video',
      year: '2026',
      desc: '为《无尽冬日》游戏独立完成的 AI 创意广告短片。从脚本策划、分镜设计到视频生成、后期剪辑均由一人完成，围绕"资源匮乏、英雄召唤、合作对抗、绝境求生"核心主题，运用 AIGC 工具全流程制作，验证了 AI 工作流在商业广告创作中的可行性与效率优势。',
      link: '',
      media: [

...
window.DEFAULT_DATA = {
  ...
  portfolio: [
    ...
    },
    {
      ...
      category: 'video',
      year: '2026',
      desc: '为《无尽冬日》游戏独立完成的 AI 创意广告短片。从脚本策划、分镜设计到视频生成、后期剪辑均由一人完成，围绕"资源匮乏、人性博弈、绝境求生"核心主题，运用 AIGC 工具全流程制作，验证了 AI 工作流在商业广告创作中的可行性与效率优势。',
      link: '',
      media: [
